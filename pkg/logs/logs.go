...
const (
	...
	ErrWriteDB         = "Произошла ошибка, последнее прочитанное сообщение было записано во временный файл"
	ErrWriteUpdFile    = "Произошла ошибка, сообщение не было записано во временный файл"
	UnwrittenUpdateNil = "Не записанных в базу данных сообщений не сущетсвует"
	UnwrittenWasWrite  = "Обновления из файла были добавлены в базу данных"
